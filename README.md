...
TedTalk requires [FFmpeg](http://ffmpeg.org/) and [SoX](http://sox.sourceforge.net/) **version 14.4.1 or later with LAME support** [important], as well as [TagLib](http://taglib.github.com/) audio meta-data library installed to the system
